-- ============================================
-- SỬA LỖI BẢNG BOOKINGS - THÊM TẤT CẢ CÁC CỘT CÒN THIẾU
-- ============================================
-- Chạy file này để thêm TẤT CẢ các cột còn thiếu vào bảng bookings
-- LƯU Ý: Nếu cột đã tồn tại sẽ báo lỗi, nhưng không sao, bỏ qua và chạy tiếp
-- ============================================

-- Thêm các cột cơ bản (chạy từng câu lệnh riêng để tránh lỗi nếu cột đã tồn tại)
