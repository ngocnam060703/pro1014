...
<div class="container mt-5" style="max-width:450px;">
    <div class="card p-4 shadow">
        ...
        <?php if (isset($_SESSION['hdv_register_success'])): ?>
            <div class="alert alert-success"><?php echo $_SESSION['hdv_register_success']; unset($_SESSION['hdv_register_success']); ?></div>
        <?php endif; ?>
        ...
        <div class="mt-3">
            <a href="index.php?act=hdv_register" class="btn btn-outline-secondary w-100 mb-2">Đăng ký HDV</a>
