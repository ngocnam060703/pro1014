...
<div class="row g-0">
    ...
    <div class="col-10 content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary"><i class="bi bi-pencil-square"></i> Sửa sự cố HDV</h3>
            ...
            <form action="index.php?act=guide-incident-update" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="severity" class="form-select" required>
                        <option value="thấp"       <?= $incident['severity']=='thấp'?'selected':'' ?>>Thấp</option>
                        <option value="trung bình" <?= $incident['severity']=='trung bình'?'selected':'' ?>>Trung bình</option>
                        <option value="cao"        <?= $incident['severity']=='cao'?'selected':'' ?>>Cao</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="3" required><?= 
                        htmlspecialchars($incident['description']) ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="solution" class="form-control" rows="3"><?= 
                        htmlspecialchars($incident['solution']) ?></textarea>
                </div>
                ...
                <!-- Upload mới -->
                <div class="mb-3">
                    <label class="form-label fw-semibold">Tải ảnh mới (nếu muốn)</label>
