...
<div class="form-container">
  <h3 class="form-header"><i class="bi bi-pencil-square"></i> Sửa lịch trình</h3>
    ...
    <div class="row g-3">
      ...
      <div class="col-12 d-flex justify-content-between mt-3">
        ...
        <button type="submit" class="btn btn-primary">
          <i class="bi bi-save"></i> Cập nhật lịch trình
        </button>
      </div>
