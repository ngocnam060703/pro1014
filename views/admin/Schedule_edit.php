  ...
  <div class="col-10 content">
    <div class="card-container fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
          <div>
              <h3 class="mb-1 fw-bold text-primary"><i class="bi bi-pencil-square"></i> Sửa lịch trình</h3>
              <p class="text-muted mb-0">Cập nhật thông tin lịch trình</p>
          </div>
      ...
      <form action="index.php?act=schedule-update" method="post">
          ...
          <div class="form-section fade-in">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" name="meeting_point" class="form-control" value="<?= htmlspecialchars($schedule['meeting_point'] ?? '') ?>" required>
              </div>
          ...
          <div class="form-section fade-in">
              ...
              <div class="mb-3">
                  ...
                  <textarea name="notes" class="form-control" rows="3" placeholder="Nhập ghi chú nếu có..."><?= htmlspecialchars($schedule['notes'] ?? '') ?></textarea>
              </div>
          </div>
