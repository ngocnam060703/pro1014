...
<div class="row g-0">
  ...
  <div class="col-10 content">
    <div class="card-container fade-in">
      ...
      <form action="index.php?act=account-store" method="post" class="fade-in">
        <div class="row g-3">
          <div class="col-md-6">
            <label class="form-label">
              <i class="bi bi-person-badge"></i> Tên đăng nhập <span class="text-danger">*</span>
            </label>
          ...
          <div class="col-md-6">
            ...
            <select name="status" class="form-select">
              <option value="active" <?= ($formData['status'] ?? 'active') == 'active' ? 'selected' : '' ?>>
        ...
        <div class="mt-4 d-flex gap-2">
          <button type="submit" class="btn btn-primary">
            <i class="bi bi-save"></i> Thêm tài khoản
          </button>
          <a href="index.php?act=account" class="btn btn-secondary">
