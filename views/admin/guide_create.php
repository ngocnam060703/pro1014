...
$guide = $guide ?? ['fullname'=>'', 'phone'=>'', 'email'=>'', 'certificate'=>''];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<div class="row g-0">
  ...
  <div class="col-2 sidebar">
    ...
    <a href="index.php?act=guide" style="color:#fff; background:#495057; border-left:3px solid #0d6efd;">
  ...
  <div class="col-10 content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold"><i class="bi bi-person-plus"></i> Thêm Hướng dẫn viên</h3>
        <a href="index.php?act=guide" class="btn btn-secondary"><i class="bi bi-arrow-left-circle"></i> Quay lại danh sách</a>
    </div>

    <div class="card p-4">
      <form action="index.php?act=guide-store" method="post" enctype="multipart/form-data">
          ...
          <div class="tab-content" id="guideTabsContent">
              ...
              <div class="tab-pane fade show active" id="basic" role="tabpanel">
                  ...
                  <div class="mb-3">
                      ...
                      <small class="text-muted">Hoặc upload file sau khi tạo</small>
                  </div>
              </div>
